...
> **Purpose:** Define the microbiome, microbiota, and metagenome in plain language so anyone on the team can explain what we measure and why.

## In one sentence

The microbiome is the vast community of microbes living in and on the body — mostly in the gut — along with all of their genes, and it is as personal to you as a fingerprint.
...
Start with the simplest idea: trillions of microscopic organisms live in and on every human body. Most people picture bacteria, and bacteria are the largest group, but the community is broader than that. It also includes **archaea, viruses, fungi, and other single-celled eukaryotes**.[^quince2017][^sorboni2022] Many of these microbes are difficult or impossible to grow in a lab dish, which is why modern DNA-based methods are needed to see them at all.[^quince2017]

Three words get used almost interchangeably, but they mean different things:

| Term | Plain-language meaning |
|------|------------------------|
| **Microbiota** | The living microbes themselves — the bugs. |
| **Microbiome** | The microbes *and* their collective genes, considered as one ecosystem. |
| **Metagenome** | All the genetic material from that community, sequenced and read together. |

Where does this community live? Microbes are spread across the skin, mouth, and other surfaces, but the large majority colonise the **gastrointestinal tract**.[^sorboni2022] That is why "the microbiome" in everyday conversation usually means the gut microbiome.
...
Every conversation we have rests on this foundation. Because the microbiome is individual and dynamic, a one-size-fits-all view is wrong — which is exactly why measuring *each person's* community matters. Understanding the microbiota/microbiome/metagenome distinction lets the team speak precisely with clinicians and customers, and reframes our offering from a single "test" into a window onto a living ecosystem that drives health.

## Common questions

**"Isn't the microbiome just gut bacteria?"**
